...
[`../sum-up/`](../sum-up/) (`sum(n) = 1 + 2 + … + n = n*(n+1)/2`), but implemented
...
| [`PROMPTS.md`](PROMPTS.md) | **The exact prompts** that produced this example, in order — the reproducibility pattern (see [`../sum-up`](../sum-up)). |
