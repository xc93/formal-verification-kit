...
When a public/in-repo test requires behavior the public issue or prompt describes as buggy, do **not** encode it as the spec: add a ledger entry **SUSPECT legacy-test obligation**, explain the conflict, and derive the claim from the best public intent evidence.
